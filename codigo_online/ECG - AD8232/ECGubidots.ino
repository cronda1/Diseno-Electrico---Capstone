...
#include <NTPClient.h>
#define WIFISSID "RL2" // Enter WifiSSID here
#define PASSWORD "RONDALAZEN1928" // Enter password here
#define TOKEN "BBFF-motC5hfJSVJcDQCyzKZUlnqvYwJJXG" // Ubidots' TOKEN
#define MQTT_CLIENT_NAME "mymqttclient" // MQTT client Name
// * Define Constants
#define VARIABLE_LABEL "ecg" // ubidots variable label
#define DEVICE_LABEL "edicina_remota" // ubidots device label
#define SENSORPIN 34 // Set the A0 as SENSORPIN
